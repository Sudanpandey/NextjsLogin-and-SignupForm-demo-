...
var signupValidationSchema = yup__WEBPACK_IMPORTED_MODULE_3__["object"]().shape({
  ...
  cpassword: yup__WEBPACK_IMPORTED_MODULE_3__["string"]().min(2, "Too Short!").max(25, "Too Long!").min(6, "Password has to be longer than 6 characters!").required(" password  is required")
});
var initialValues = {
  firstname: " ",
  lastname: "   ",
...
//# sourceMappingURL=signUp.js.2dc27a807c92ecc4efcc.hot-update.js.map